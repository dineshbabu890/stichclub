...
class Login extends Component {
  ...
  login(){
    ...
    axios.post(`${API_CONST.DEV_URL+API_CONST.USERLOGIN_API}`,loginData)
      .then(res => {
        console.log(res);
  ...
  <div className="container-login100">
    <div className="wrap-login100">
      <div className="login100-form-title" style={{backgroundImage: 'url(images/banner8.jpg)'}}>
      ...
      <form className="login100-form validate-form">
        <div className="wrap-input100 validate-input m-b-26" data-validate="Username is required">
          ...
          <input autofocus="autofocus" onChange={(event) => {this.onTextChange('email',event.target.value)}} required="required"  value={this.state.email} className="input100" type="email" name="designer[email]" id="designer_email" placeholder="Enter username" />
        ...
        <br/>
            ...
            <p>Create a new stichclub account  ? <a href="/register" className="useterms">Sign up »</a></p>
      </form>
    </div>
  </div>
</div>
