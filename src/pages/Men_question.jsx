...
class MenQuestion extends Component {
  state = {
    checked: true
  }
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h4 className="modal-title">We would like to Approve Mens Fitting Size !!</h4>
          ...
          <div className="modal-footer">
            <a  href="/men_question1" className="btn btn-primary">Continue</a>
