...
class Women extends Component {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            <a  href="/women_question" className="btn btn-primary">Continue</a>
  ...
  render() {
    return (
      <div>
        <Navbar />
        <section className="howtowork_section___14DEF howtowork_gateway___M3NtT">
        {/* <h2 class="howtowork_section-title___2S6np">How It Works</h2> */}
          <div className="content">
              ...
              <button type="button" className="prev" data-toggle="modal" data-target="#myModal">
