...
class MenQuestion1 extends Component {
  ...
  <div className="content">
    ...
    <div className="container-fluid">
      ...
      <br />
        ...
        <div className="container">
         ...
         <input id="slimm" name="limmshirt" type="radio" />
       ...
       <div className="selection">
         ...
         <label htmlFor="regular">REGULAR</label>
          ...
          <h3 className="text-center mens_head">How do you typically spend on those items?</h3><br />  
            ...
            <div className="col-md-3"></div>
                ...
                <div className="selection">
                  <input id="shoe" name="mwwshoes" type="radio" />
                  <label htmlFor="shoe">50-100K</label>
                </div>
                <div className="selection">
                  <input id="shoe1" name="1mwshoes" type="radio" />
                  <label htmlFor="shoe1">100-200K</label>
                </div>
                <div className="selection">
                  <input id="shoe2" name="2mwshoes" type="radio" />
          ...
          <div className="col-md-3"></div>
            ...
            <div className="selection">
              <input id="sweaters1" name="1mwsweaters" type="radio" />
              <label htmlFor="sweaters1">100-200K</label>
            </div>
            <div className="selection">
              <input id="sweaters2" name="2mwsweaters" type="radio" />
        ...
        <div className="col-md-3"></div>
            ...
            <div className="selection">
              <input id="jeans1" name="1mwjeans" type="radio" />
              <label htmlFor="jeans1">100-200K</label>
            </div>
            <div className="selection">
              <input id="jeans2" name="2mwjeans" type="radio" />
          ...
          <div className="col-md-2">
          <div className="selection">
          <input id="medium" name="mediumsize" type="radio" />
    ...
    <div className="selection">
    <input id="dont" name="dontsize" type="radio" />
          <label htmlFor="dont">I Don't Know</label>
      </div>
        </div>
            <div className="col-md-2">
                <div className="selection">
                  <input id="long" name="llsize" type="radio" />
          ...
          <h3 className="text-center mens_head">Whats your waist size?</h3>  
            ...
            <div className="col-md-2">
            <div className="selection">
            <input id="wrist1" name="1wrist" type="radio" />
    ...
    <label htmlFor="know">I Don't Know</label>
        ...
        <a href="/womens_step3"><button className="example_e"><span> NEXT</span></button></a>
